 ...
 */
public class BranchPicker extends DialogFragment {
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        builder.setTitle("Please Select Your Nearest Branch...");
        ...
        builder.setPositiveButton("Done", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                ...
                BranchActivity.pickedBranch.setText(selection);
                AccountMenuActivity.accBranch = selection;
            }
        });

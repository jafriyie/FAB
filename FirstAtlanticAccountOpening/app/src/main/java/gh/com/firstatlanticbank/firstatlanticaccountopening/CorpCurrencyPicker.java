 ...
 */
public class CorpCurrencyPicker extends DialogFragment {
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        builder.setPositiveButton("Done", new DialogInterface.OnClickListener() {
            @Override
            public void onClick(DialogInterface dialog, int which) {
                CorporateActivity.corpCurrency.setText(selection);
                Toast.makeText(getActivity(), "Your selected currency is : " + selection, Toast.LENGTH_LONG).show();
            }
        });
